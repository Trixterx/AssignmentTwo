...
namespace AssignmentTwo
{
    ...
    class Program
    {
        ...
        {
            foreach (var member in classMates)
            {
        ...
        public static void CreateMembers()
        {
            ...
            List<ClassMate> classMates = new List<ClassMate>() { DennisLindquist, FredrikHoffman, BennyChristensen, HakanEriksson, TinaEriksson, TobiasBinett, EmilOrjes, MattiasVikstrom, NicklasEriksson, JosefineRonnqvist };
        }
    }
}
